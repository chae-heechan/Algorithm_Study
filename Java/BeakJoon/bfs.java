...
//        while (queue.size() != 0) {
//            temp = queue.poll();
//            if (temp.get(0) + 1 < n && area[temp.get(0) + 1][temp.get(1)] == 1
//                    && visited[temp.get(0) + 1][temp.get(1)] == 0) {
//                queue.add(List.of(temp.get(0) + 1, temp.get(1)));
//                visited[temp.get(0) + 1][temp.get(1)] = 1;
//            }
//            if (temp.get(1) + 1 < n && area[temp.get(0)][temp.get(1) + 1] == 1
//                    && visited[temp.get(0)][temp.get(1) + 1] == 0) {
